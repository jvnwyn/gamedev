...
const SPAWN_POINTS = {
	1: {
		"left": Vector3(139.354446, -13.050052, 8.122311),
		"right": Vector3(-156.683899, -13.050052, -6.316)
	},
	2: {
		"left": Vector3(161.127502, -5.89223, 7.395763),
		"right": Vector3(-148.320618, -5.89223, -9.219653)
	}
}
